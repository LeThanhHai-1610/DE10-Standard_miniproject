...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../Miniproject.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../niosiisystem.sopcinfo
...
# Design Name 
# setting SOPC_NAME is niosiisystem
SOPC_NAME := niosiisystem
...
# The SOPC System ID 
# setting SOPC_SYSID is 67637392
SOPC_SYSID_FLAG += --id=67637392
ELF_PATCH_FLAG  += --id 67637392

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x4081090
SOPC_SYSID_FLAG += --sidp=0x4081090
ELF_PATCH_FLAG  += --sidp 0x4081090

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1619064928
SOPC_SYSID_FLAG += --timestamp=1619064928
ELF_PATCH_FLAG  += --timestamp 1619064928
