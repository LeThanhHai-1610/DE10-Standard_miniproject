// niosiisystem_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module niosiisystem_mm_interconnect_0 (
		...
		output wire [24:0] DRAM_s1_address,                                //                                  DRAM_s1.address
		output wire        DRAM_s1_write,                                  //                                         .write
		output wire        DRAM_s1_read,                                   //                                         .read
		input  wire [15:0] DRAM_s1_readdata,                               //                                         .readdata
		output wire [15:0] DRAM_s1_writedata,                              //                                         .writedata
		output wire [1:0]  DRAM_s1_byteenable,                             //                                         .byteenable
		input  wire        DRAM_s1_readdatavalid,                          //                                         .readdatavalid
		input  wire        DRAM_s1_waitrequest,                            //                                         .waitrequest
	...
	wire   [10:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> adc_0_adc_slave_agent:cp_channel
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> IMEM_s1_agent:cp_valid
	wire  [104:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> IMEM_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // IMEM_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [10:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> IMEM_s1_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> IMEM_s1_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> IMEM_s1_agent:cp_endofpacket
	wire   [15:0] dram_s1_agent_m0_readdata;                                                          // DRAM_s1_translator:uav_readdata -> DRAM_s1_agent:m0_readdata
	wire          dram_s1_agent_m0_waitrequest;                                                       // DRAM_s1_translator:uav_waitrequest -> DRAM_s1_agent:m0_waitrequest
	wire          dram_s1_agent_m0_debugaccess;                                                       // DRAM_s1_agent:m0_debugaccess -> DRAM_s1_translator:uav_debugaccess
	wire   [26:0] dram_s1_agent_m0_address;                                                           // DRAM_s1_agent:m0_address -> DRAM_s1_translator:uav_address
	wire    [1:0] dram_s1_agent_m0_byteenable;                                                        // DRAM_s1_agent:m0_byteenable -> DRAM_s1_translator:uav_byteenable
	wire          dram_s1_agent_m0_read;                                                              // DRAM_s1_agent:m0_read -> DRAM_s1_translator:uav_read
	wire          dram_s1_agent_m0_readdatavalid;                                                     // DRAM_s1_translator:uav_readdatavalid -> DRAM_s1_agent:m0_readdatavalid
	wire          dram_s1_agent_m0_lock;                                                              // DRAM_s1_agent:m0_lock -> DRAM_s1_translator:uav_lock
	wire   [15:0] dram_s1_agent_m0_writedata;                                                         // DRAM_s1_agent:m0_writedata -> DRAM_s1_translator:uav_writedata
	wire          dram_s1_agent_m0_write;                                                             // DRAM_s1_agent:m0_write -> DRAM_s1_translator:uav_write
	wire    [1:0] dram_s1_agent_m0_burstcount;                                                        // DRAM_s1_agent:m0_burstcount -> DRAM_s1_translator:uav_burstcount
	wire          dram_s1_agent_rf_source_valid;                                                      // DRAM_s1_agent:rf_source_valid -> DRAM_s1_agent_rsp_fifo:in_valid
	wire   [87:0] dram_s1_agent_rf_source_data;                                                       // DRAM_s1_agent:rf_source_data -> DRAM_s1_agent_rsp_fifo:in_data
	wire          dram_s1_agent_rf_source_ready;                                                      // DRAM_s1_agent_rsp_fifo:in_ready -> DRAM_s1_agent:rf_source_ready
	wire          dram_s1_agent_rf_source_startofpacket;                                              // DRAM_s1_agent:rf_source_startofpacket -> DRAM_s1_agent_rsp_fifo:in_startofpacket
	wire          dram_s1_agent_rf_source_endofpacket;                                                // DRAM_s1_agent:rf_source_endofpacket -> DRAM_s1_agent_rsp_fifo:in_endofpacket
	wire          dram_s1_agent_rsp_fifo_out_valid;                                                   // DRAM_s1_agent_rsp_fifo:out_valid -> DRAM_s1_agent:rf_sink_valid
	wire   [87:0] dram_s1_agent_rsp_fifo_out_data;                                                    // DRAM_s1_agent_rsp_fifo:out_data -> DRAM_s1_agent:rf_sink_data
	wire          dram_s1_agent_rsp_fifo_out_ready;                                                   // DRAM_s1_agent:rf_sink_ready -> DRAM_s1_agent_rsp_fifo:out_ready
	wire          dram_s1_agent_rsp_fifo_out_startofpacket;                                           // DRAM_s1_agent_rsp_fifo:out_startofpacket -> DRAM_s1_agent:rf_sink_startofpacket
	wire          dram_s1_agent_rsp_fifo_out_endofpacket;                                             // DRAM_s1_agent_rsp_fifo:out_endofpacket -> DRAM_s1_agent:rf_sink_endofpacket
	wire          dram_s1_agent_rdata_fifo_src_valid;                                                 // DRAM_s1_agent:rdata_fifo_src_valid -> DRAM_s1_agent_rdata_fifo:in_valid
	wire   [17:0] dram_s1_agent_rdata_fifo_src_data;                                                  // DRAM_s1_agent:rdata_fifo_src_data -> DRAM_s1_agent_rdata_fifo:in_data
	wire          dram_s1_agent_rdata_fifo_src_ready;                                                 // DRAM_s1_agent_rdata_fifo:in_ready -> DRAM_s1_agent:rdata_fifo_src_ready
	...
	wire  [104:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> LEDR_s1_agent:cp_data
	...
	wire   [10:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> timer_1_s1_agent:cp_channel
	...
	wire   [26:0] gpio_s1_agent_m0_address;                                                           // GPIO_s1_agent:m0_address -> GPIO_s1_translator:uav_address
	...
	wire  [104:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> GPIO_s1_agent:cp_data
	...
	wire          imem_s1_agent_rp_valid;                                                             // IMEM_s1_agent:rp_valid -> router_006:sink_valid
	wire  [104:0] imem_s1_agent_rp_data;                                                              // IMEM_s1_agent:rp_data -> router_006:sink_data
	wire          imem_s1_agent_rp_ready;                                                             // router_006:sink_ready -> IMEM_s1_agent:rp_ready
	wire          imem_s1_agent_rp_startofpacket;                                                     // IMEM_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          imem_s1_agent_rp_endofpacket;                                                       // IMEM_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          dram_s1_agent_rp_valid;                                                             // DRAM_s1_agent:rp_valid -> router_007:sink_valid
	wire   [86:0] dram_s1_agent_rp_data;                                                              // DRAM_s1_agent:rp_data -> router_007:sink_data
	wire          dram_s1_agent_rp_ready;                                                             // router_007:sink_ready -> DRAM_s1_agent:rp_ready
	wire          dram_s1_agent_rp_startofpacket;                                                     // DRAM_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          dram_s1_agent_rp_endofpacket;                                                       // DRAM_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [104:0] ledr_s1_agent_rp_data;                                                              // LEDR_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [104:0] gpio_s1_agent_rp_data;                                                              // GPIO_s1_agent:rp_data -> router_012:sink_data
	...
	wire          dram_s1_burst_adapter_source0_valid;                                                // DRAM_s1_burst_adapter:source0_valid -> DRAM_s1_agent:cp_valid
	wire   [86:0] dram_s1_burst_adapter_source0_data;                                                 // DRAM_s1_burst_adapter:source0_data -> DRAM_s1_agent:cp_data
	wire          dram_s1_burst_adapter_source0_ready;                                                // DRAM_s1_agent:cp_ready -> DRAM_s1_burst_adapter:source0_ready
	wire   [10:0] dram_s1_burst_adapter_source0_channel;                                              // DRAM_s1_burst_adapter:source0_channel -> DRAM_s1_agent:cp_channel
	wire          dram_s1_burst_adapter_source0_startofpacket;                                        // DRAM_s1_burst_adapter:source0_startofpacket -> DRAM_s1_agent:cp_startofpacket
	wire          dram_s1_burst_adapter_source0_endofpacket;                                          // DRAM_s1_burst_adapter:source0_endofpacket -> DRAM_s1_agent:cp_endofpacket
	...
	wire          router_007_src_valid;                                                               // router_007:src_valid -> DRAM_s1_rsp_width_adapter:in_valid
	wire   [86:0] router_007_src_data;                                                                // router_007:src_data -> DRAM_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                               // DRAM_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire   [10:0] router_007_src_channel;                                                             // router_007:src_channel -> DRAM_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                                       // router_007:src_startofpacket -> DRAM_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                                         // router_007:src_endofpacket -> DRAM_s1_rsp_width_adapter:in_endofpacket
	wire          dram_s1_rsp_width_adapter_src_valid;                                                // DRAM_s1_rsp_width_adapter:out_valid -> rsp_demux_005:sink_valid
	wire  [104:0] dram_s1_rsp_width_adapter_src_data;                                                 // DRAM_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          dram_s1_rsp_width_adapter_src_ready;                                                // rsp_demux_005:sink_ready -> DRAM_s1_rsp_width_adapter:out_ready
	wire   [10:0] dram_s1_rsp_width_adapter_src_channel;                                              // DRAM_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	wire          dram_s1_rsp_width_adapter_src_startofpacket;                                        // DRAM_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_005:sink_startofpacket
	wire          dram_s1_rsp_width_adapter_src_endofpacket;                                          // DRAM_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_005:sink_endofpacket
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> DRAM_s1_cmd_width_adapter:in_valid
	wire  [104:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> DRAM_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                              // DRAM_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire   [10:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> DRAM_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> DRAM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> DRAM_s1_cmd_width_adapter:in_endofpacket
	wire          dram_s1_cmd_width_adapter_src_valid;                                                // DRAM_s1_cmd_width_adapter:out_valid -> DRAM_s1_burst_adapter:sink0_valid
	wire   [86:0] dram_s1_cmd_width_adapter_src_data;                                                 // DRAM_s1_cmd_width_adapter:out_data -> DRAM_s1_burst_adapter:sink0_data
	wire          dram_s1_cmd_width_adapter_src_ready;                                                // DRAM_s1_burst_adapter:sink0_ready -> DRAM_s1_cmd_width_adapter:out_ready
	wire   [10:0] dram_s1_cmd_width_adapter_src_channel;                                              // DRAM_s1_cmd_width_adapter:out_channel -> DRAM_s1_burst_adapter:sink0_channel
	wire          dram_s1_cmd_width_adapter_src_startofpacket;                                        // DRAM_s1_cmd_width_adapter:out_startofpacket -> DRAM_s1_burst_adapter:sink0_startofpacket
	wire          dram_s1_cmd_width_adapter_src_endofpacket;                                          // DRAM_s1_cmd_width_adapter:out_endofpacket -> DRAM_s1_burst_adapter:sink0_endofpacket
	...
	wire          imem_s1_agent_rdata_fifo_src_valid;                                                 // IMEM_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] imem_s1_agent_rdata_fifo_src_data;                                                  // IMEM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          imem_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_004:in_0_ready -> IMEM_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> IMEM_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> IMEM_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // IMEM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> IMEM_s1_agent:rdata_fifo_sink_error
	wire          dram_s1_agent_rdata_fifo_out_valid;                                                 // DRAM_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [17:0] dram_s1_agent_rdata_fifo_out_data;                                                  // DRAM_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          dram_s1_agent_rdata_fifo_out_ready;                                                 // avalon_st_adapter_005:in_0_ready -> DRAM_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> DRAM_s1_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> DRAM_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                  // DRAM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> DRAM_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (sys_sdram_pll_0_sys_clk_clk),                    //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (dram_s1_agent_m0_address),                       // avalon_universal_slave_0.address
		.uav_burstcount         (dram_s1_agent_m0_burstcount),                    //                         .burstcount
		.uav_read               (dram_s1_agent_m0_read),                          //                         .read
		.uav_write              (dram_s1_agent_m0_write),                         //                         .write
		.uav_waitrequest        (dram_s1_agent_m0_waitrequest),                   //                         .waitrequest
		.uav_readdatavalid      (dram_s1_agent_m0_readdatavalid),                 //                         .readdatavalid
		.uav_byteenable         (dram_s1_agent_m0_byteenable),                    //                         .byteenable
		.uav_readdata           (dram_s1_agent_m0_readdata),                      //                         .readdata
		.uav_writedata          (dram_s1_agent_m0_writedata),                     //                         .writedata
		.uav_lock               (dram_s1_agent_m0_lock),                          //                         .lock
		.uav_debugaccess        (dram_s1_agent_m0_debugaccess),                   //                         .debugaccess
		.av_address             (DRAM_s1_address),                                //      avalon_anti_slave_0.address
		.av_write               (DRAM_s1_write),                                  //                         .write
		.av_read                (DRAM_s1_read),                                   //                         .read
		.av_readdata            (DRAM_s1_readdata),                               //                         .readdata
		.av_writedata           (DRAM_s1_writedata),                              //                         .writedata
		.av_byteenable          (DRAM_s1_byteenable),                             //                         .byteenable
		.av_readdatavalid       (DRAM_s1_readdatavalid),                          //                         .readdatavalid
		.av_waitrequest         (DRAM_s1_waitrequest),                            //                         .waitrequest
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (sys_sdram_pll_0_sys_clk_clk),                    //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (dram_s1_agent_m0_address),                       //              m0.address
		.m0_burstcount           (dram_s1_agent_m0_burstcount),                    //                .burstcount
		.m0_byteenable           (dram_s1_agent_m0_byteenable),                    //                .byteenable
		.m0_debugaccess          (dram_s1_agent_m0_debugaccess),                   //                .debugaccess
		.m0_lock                 (dram_s1_agent_m0_lock),                          //                .lock
		.m0_readdata             (dram_s1_agent_m0_readdata),                      //                .readdata
		.m0_readdatavalid        (dram_s1_agent_m0_readdatavalid),                 //                .readdatavalid
		.m0_read                 (dram_s1_agent_m0_read),                          //                .read
		.m0_waitrequest          (dram_s1_agent_m0_waitrequest),                   //                .waitrequest
		.m0_writedata            (dram_s1_agent_m0_writedata),                     //                .writedata
		.m0_write                (dram_s1_agent_m0_write),                         //                .write
		.rp_endofpacket          (dram_s1_agent_rp_endofpacket),                   //              rp.endofpacket
		.rp_ready                (dram_s1_agent_rp_ready),                         //                .ready
		.rp_valid                (dram_s1_agent_rp_valid),                         //                .valid
		.rp_data                 (dram_s1_agent_rp_data),                          //                .data
		.rp_startofpacket        (dram_s1_agent_rp_startofpacket),                 //                .startofpacket
		.cp_ready                (dram_s1_burst_adapter_source0_ready),            //              cp.ready
		.cp_valid                (dram_s1_burst_adapter_source0_valid),            //                .valid
		.cp_data                 (dram_s1_burst_adapter_source0_data),             //                .data
		.cp_startofpacket        (dram_s1_burst_adapter_source0_startofpacket),    //                .startofpacket
		.cp_endofpacket          (dram_s1_burst_adapter_source0_endofpacket),      //                .endofpacket
		.cp_channel              (dram_s1_burst_adapter_source0_channel),          //                .channel
		.rf_sink_ready           (dram_s1_agent_rsp_fifo_out_ready),               //         rf_sink.ready
		.rf_sink_valid           (dram_s1_agent_rsp_fifo_out_valid),               //                .valid
		.rf_sink_startofpacket   (dram_s1_agent_rsp_fifo_out_startofpacket),       //                .startofpacket
		.rf_sink_endofpacket     (dram_s1_agent_rsp_fifo_out_endofpacket),         //                .endofpacket
		.rf_sink_data            (dram_s1_agent_rsp_fifo_out_data),                //                .data
		.rf_source_ready         (dram_s1_agent_rf_source_ready),                  //       rf_source.ready
		.rf_source_valid         (dram_s1_agent_rf_source_valid),                  //                .valid
		.rf_source_startofpacket (dram_s1_agent_rf_source_startofpacket),          //                .startofpacket
		.rf_source_endofpacket   (dram_s1_agent_rf_source_endofpacket),            //                .endofpacket
		.rf_source_data          (dram_s1_agent_rf_source_data),                   //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),              //                .error
		.rdata_fifo_src_ready    (dram_s1_agent_rdata_fifo_src_ready),             //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (dram_s1_agent_rdata_fifo_src_valid),             //                .valid
		.rdata_fifo_src_data     (dram_s1_agent_rdata_fifo_src_data),              //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) dram_s1_agent_rsp_fifo (
		.clk               (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (dram_s1_agent_rf_source_data),                   //        in.data
		.in_valid          (dram_s1_agent_rf_source_valid),                  //          .valid
		.in_ready          (dram_s1_agent_rf_source_ready),                  //          .ready
		.in_startofpacket  (dram_s1_agent_rf_source_startofpacket),          //          .startofpacket
		.in_endofpacket    (dram_s1_agent_rf_source_endofpacket),            //          .endofpacket
		.out_data          (dram_s1_agent_rsp_fifo_out_data),                //       out.data
		.out_valid         (dram_s1_agent_rsp_fifo_out_valid),               //          .valid
		.out_ready         (dram_s1_agent_rsp_fifo_out_ready),               //          .ready
		.out_startofpacket (dram_s1_agent_rsp_fifo_out_startofpacket),       //          .startofpacket
		.out_endofpacket   (dram_s1_agent_rsp_fifo_out_endofpacket),         //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) dram_s1_agent_rdata_fifo (
		.clk               (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (dram_s1_agent_rdata_fifo_src_data),              //        in.data
		.in_valid          (dram_s1_agent_rdata_fifo_src_valid),             //          .valid
		.in_ready          (dram_s1_agent_rdata_fifo_src_ready),             //          .ready
		.out_data          (dram_s1_agent_rdata_fifo_out_data),              //       out.data
		.out_valid         (dram_s1_agent_rdata_fifo_out_valid),             //          .valid
		.out_ready         (dram_s1_agent_rdata_fifo_out_ready),             //          .ready
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	niosiisystem_mm_interconnect_0_router router (
	...
	niosiisystem_mm_interconnect_0_router_001 router_001 (
	...
	niosiisystem_mm_interconnect_0_router_002 router_002 (
	...
	niosiisystem_mm_interconnect_0_router_002 router_003 (
	...
	niosiisystem_mm_interconnect_0_router_002 router_004 (
	...
	niosiisystem_mm_interconnect_0_router_005 router_005 (
	...
	niosiisystem_mm_interconnect_0_router_005 router_006 (
	...
	niosiisystem_mm_interconnect_0_router_007 router_007 (
		.sink_ready         (dram_s1_agent_rp_ready),                         //      sink.ready
		.sink_valid         (dram_s1_agent_rp_valid),                         //          .valid
		.sink_data          (dram_s1_agent_rp_data),                          //          .data
		.sink_startofpacket (dram_s1_agent_rp_startofpacket),                 //          .startofpacket
		.sink_endofpacket   (dram_s1_agent_rp_endofpacket),                   //          .endofpacket
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_router_002 router_008 (
	...
	niosiisystem_mm_interconnect_0_router_002 router_009 (
	...
	niosiisystem_mm_interconnect_0_router_002 router_010 (
	...
	niosiisystem_mm_interconnect_0_router_002 router_011 (
	...
	niosiisystem_mm_interconnect_0_router_002 router_012 (
	...
	) dram_s1_burst_adapter (
		.clk                   (sys_sdram_pll_0_sys_clk_clk),                    //       cr0.clk
		.reset                 (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // cr0_reset.reset
		.sink0_valid           (dram_s1_cmd_width_adapter_src_valid),            //     sink0.valid
		.sink0_data            (dram_s1_cmd_width_adapter_src_data),             //          .data
		.sink0_channel         (dram_s1_cmd_width_adapter_src_channel),          //          .channel
		.sink0_startofpacket   (dram_s1_cmd_width_adapter_src_startofpacket),    //          .startofpacket
		.sink0_endofpacket     (dram_s1_cmd_width_adapter_src_endofpacket),      //          .endofpacket
		.sink0_ready           (dram_s1_cmd_width_adapter_src_ready),            //          .ready
		.source0_valid         (dram_s1_burst_adapter_source0_valid),            //   source0.valid
		.source0_data          (dram_s1_burst_adapter_source0_data),             //          .data
		.source0_channel       (dram_s1_burst_adapter_source0_channel),          //          .channel
		.source0_startofpacket (dram_s1_burst_adapter_source0_startofpacket),    //          .startofpacket
		.source0_endofpacket   (dram_s1_burst_adapter_source0_endofpacket),      //          .endofpacket
		.source0_ready         (dram_s1_burst_adapter_source0_ready)             //          .ready
	);

	niosiisystem_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),               //       clk.clk
		.reset               (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),               //       clk.clk
		.reset               (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_mux cmd_mux_010 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.sink_ready         (dram_s1_rsp_width_adapter_src_ready),            //      sink.ready
		.sink_channel       (dram_s1_rsp_width_adapter_src_channel),          //          .channel
		.sink_data          (dram_s1_rsp_width_adapter_src_data),             //          .data
		.sink_startofpacket (dram_s1_rsp_width_adapter_src_startofpacket),    //          .startofpacket
		.sink_endofpacket   (dram_s1_rsp_width_adapter_src_endofpacket),      //          .endofpacket
		.sink_valid         (dram_s1_rsp_width_adapter_src_valid),            //          .valid
	...
	niosiisystem_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),               //       clk.clk
		.reset              (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),               //       clk.clk
		.reset              (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_rsp_demux rsp_demux_010 (
		.clk                (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                  (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset                (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosiisystem_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (sys_sdram_pll_0_sys_clk_clk),                    //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (dram_s1_rsp_width_adapter_src_endofpacket),      //       src.endofpacket
		.out_data             (dram_s1_rsp_width_adapter_src_data),             //          .data
		.out_channel          (dram_s1_rsp_width_adapter_src_channel),          //          .channel
		.out_valid            (dram_s1_rsp_width_adapter_src_valid),            //          .valid
		.out_ready            (dram_s1_rsp_width_adapter_src_ready),            //          .ready
		.out_startofpacket    (dram_s1_rsp_width_adapter_src_startofpacket),    //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (dram_s1_cmd_width_adapter_src_endofpacket),      //       src.endofpacket
		.out_data             (dram_s1_cmd_width_adapter_src_data),             //          .data
		.out_channel          (dram_s1_cmd_width_adapter_src_channel),          //          .channel
		.out_valid            (dram_s1_cmd_width_adapter_src_valid),            //          .valid
		.out_ready            (dram_s1_cmd_width_adapter_src_ready),            //          .ready
		.out_startofpacket    (dram_s1_cmd_width_adapter_src_startofpacket),    //          .startofpacket
		.in_command_size_data (3'b000)                                          // (terminated)
	);

	niosiisystem_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	niosiisystem_mm_interconnect_0_avalon_st_adapter_005 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
		...
		.in_clk_0_clk   (sys_sdram_pll_0_sys_clk_clk),                    // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (dram_s1_agent_rdata_fifo_out_data),              //     in_0.data
		.in_0_valid     (dram_s1_agent_rdata_fifo_out_valid),             //         .valid
		.in_0_ready     (dram_s1_agent_rdata_fifo_out_ready),             //         .ready
